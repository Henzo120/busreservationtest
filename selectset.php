...
<input type="text" name="fname"  id="name"placeholder="Enter first name"/><br>
<label>Last Name
<span class="small"$placeholder="Enter last name"</span>
</label>
<input type="text" name="lname"  id="name"placeholder="Enter last name"/><br>
<label>Address
</label>
...
<input type="text" name="contact"  id="name"placeholder="Enter contact No."/><br>
