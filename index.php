...
<div id="wrapper">
    ...
    <div id="featured">
        <div id="items">
            ...
            <div class="item"> <a href="login.php"><img src="xres/images/selamb.png" alt="" /></a>
            <h3><a href="login.php">New Route start soon!</a></h3>
           			<p><strong> A.A TO Keniya </strong><br />
			<p><strong> A.A TO Sudan</strong><br />
       </a></p>  
      </div>
  ...
  <div id="footer">
  <h4>+251 90 744 9124 &bull; <a href="contact.php"> @ Click Here to Cantact Us   </a></h4>
  <h5>New Mode Selam Bus  &nbsp;&nbsp;&bull;&nbsp;&nbsp; Coming soon! </h5>
